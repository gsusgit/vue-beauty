...
export async function sendEmailVerification({name, email, token}) {
    ...
    const info = await transporter.sendMail({
        ...
        html: `<h3 style="font-size:1.4rem;line-height:1.8rem;font-weight:normal;font-family:Arial,sans-serif;">Hola, <b>${name}</b></h3>
               ...
               <p style="font-family:Arial,sans-serif;">Confirma tu cuenta de usuario haciendo clic en el <a href="http://localhost:4000/api/auth/verify/${token}">siguiente enlace</a></p>
